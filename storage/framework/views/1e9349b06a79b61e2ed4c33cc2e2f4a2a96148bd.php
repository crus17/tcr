    ...
    <div class="iq-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="logo">
                        <a href="index"><img id="logo_img" id="logo_img" class="img-fluid" src="<?php echo e(asset('zenith/images/logo-white.png')); ?>" alt="logo"></a>
                    </div>
...
<h3 class="title text-uppercase iq-font-white iq-tw-6">History</h3>
    ...
    <p><?php echo e($settings->site_name); ?> has come a long way and has made huge progress within the past couple of months. Go through our timeline to see for yourself how far we have come</p>
</div>
</div>
</div>
...
<div class="timeline-content">
    <h5 class="iq-font-dark iq-tw-5">LAUNCH OF <?php echo e($settings->site_name); ?></h5>
<span>June</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 iq-mtb-60">
                    ...
                    <div class="iq-font-white iq-mt-15 "><?php echo e($settings->site_name); ?> bot is a trading platform that pays his investors 5% daily for 30days. 
