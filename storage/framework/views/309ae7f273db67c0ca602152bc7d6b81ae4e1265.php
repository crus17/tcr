...
<div class="overview-block-pt iq-feature4 iq-bg iq-over-black-80 jarallax particles-bg" style="background-image: url(<?php echo e(asset('zenith/images/bg/bg-7.jpg')); ?>); background-position: center center;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <img class="img-fluid" src="<?php echo e(asset('zenith/images/about-us/chart.png')); ?>" alt="#">
            </div>
            <div class="col-sm-1"></div>
        </div>
    </div>
...
<div class="row">
<div class="col-lg-6">
<script data-cfasync="false" src="<?php echo e(asset('zenith/js/email-decode.min.js')); ?>"></script><script data-cfasync="false" src="<?php echo e(asset('zenith/js/email-decode.min.js')); ?>"></script><script>
...
<a class="button pull-right" href="javascript:void(0)">buy now</a>
 ...
 <div class="overview-block-ptb3 iq-bg iq-over-black-80 jarallax" style="background-image: url(<?php echo e(asset('zenith/images/bg/bg-5.jpg')); ?>); background-position: center center;">
<div class="container">
<div class="row">
