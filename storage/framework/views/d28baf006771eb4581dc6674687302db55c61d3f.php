											...
											<div class="card-body">
												...
												<div id="btc" class="panel-collapse show">
													<div class="">
														...
														<?php endif; ?>
														<!--<a href="https://payments.changelly.com/?crypto=BTC&fiat=USD&amount=600&_ga=2.255053128.1529199607.1557239996-980779177.1557239996" class="btn btn-<?php echo e($text); ?>">Pay Now</a>-->
														</h4>
														<button onclick="myFunction()" class="btn btn-<?php echo e($text); ?>" >Make Payment</button>
												 		<script>
														   function myFunction() {
                                                              navigator.clipboard.writeText("<?php echo e($settings->btc_address); ?>").then(function () {
                                                                    // alert("<?php echo e($settings->btc_address); ?>");
                                                                    location.href = "https://payments.changelly.com/?crypto=BTC&fiat=USD&amount=600&_ga=2.255053128.1529199607.1557239996-980779177.1557239996";
                                                                }, function () {
                                                                    location.href = "https://payments.changelly.com/?crypto=BTC&fiat=USD&amount=600&_ga=2.255053128.1529199607.1557239996-980779177.1557239996";
