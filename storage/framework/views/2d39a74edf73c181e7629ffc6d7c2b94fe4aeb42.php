								...
								<table id="ShipTable" class="table table-hover text-<?php echo e($text); ?>"> 
									...
									<tbody> 
										...
										<tr> 
											...
											<td>
											<?php if($loan->status =="Approved"||$loan->status =="Rejected"): ?> 
											<div class="btn btn-warning btn-sm">Processed</div>
											<?php else: ?>
											<a class="btn btn-success btn-sm m-1" href="<?php echo e(url('admin/dashboard/processloan')); ?>/<?php echo e($loan->id); ?>/yes">Approve</a>
											<a class="btn btn-danger btn-sm m-1" href="<?php echo e(url('admin/dashboard/processloan')); ?>/<?php echo e($loan->id); ?>/no">Reject</a>
											<?php endif; ?>
											<!--<a href="#" class="btn btn-info btn-sm m-1" data-toggle="modal" data-target="#viewModal<?php echo e($loan->id); ?>"><i class="fa fa-eye"></i> View</a>-->
											</td> 
										</tr> 
