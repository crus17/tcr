...
<head>
    ...
    <link rel="icon" href="{{ asset ('home/imgages/favicon.png')}}" type="image/png" sizes="32x32">
...
<div class="overview-block-pt iq-feature4 iq-bg iq-over-black-80 jarallax particles-bg" style="background-image: url({{ asset('home/images/bg/bg-7.jpg') }}); background-position: center center;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <img class="img-fluid" src="{{ asset('home/images/about-us/chart.png') }}" alt="#">
            </div>
            <div class="col-sm-1"></div>
        </div>
    </div>
...
<div class="row">
<div class="col-lg-6">
<script data-cfasync="false" src="{{ asset('home/js/email-decode.min.js') }}"></script><script data-cfasync="false" src="{{ asset('home/js/email-decode.min.js') }}"></script><script>
