...
<div id="notification-1" class="notification">			
	<div class="notification-block">
        ...
        <!--Header End-->
<!--alert js-->
        <script src="assets/2c894dd02c6b44d3f52684ceaed3f874/sweetalert.min.js"></script>
...
<!--/alert js-->
        ...
        <div class="midd-container">
            <!-- Hero Section Start -->   
            <div class="hero-main mercury-layout white-sec" style="background:url({{ asset('ultracry/images/banner-6.jpg')}}">
                <div class="container">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="benefit-box text-center">
                                <div class="benefit-icon">
                                    <img src="{{asset('ultracry/images/benefit-icon-3.png') }}" alt="World Coverage">
                                </div>
                                <div class="text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="benefit-box text-center">
                                <div class="benefit-icon">
                                    <img src="{{asset('ultracry/images/benefit-icon-5.png') }}" alt="Strong Network">
                                </div>
                                <div class="text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="benefit-box text-center">
                                <div class="benefit-icon">
                                    <img src="{{asset('ultracry/images/benefit-icon-6.png') }}" alt="Margin Trading">
                                </div>
                                <div class="text">
...
aa14458f8082d9c4265ef491ca0b5d4801c16bbf7a4aece7b70a0b4824ffdfea
            ...
            <div class="brand-logo-slider c-l p-tb white-sec">
                <div class="container">
                    ...
                    <div class="brand-logos owl-carousel">
                        <div class="item"><img src="{{ asset ('ultracry/images/brand-logo1.png')}}" alt="Brand Logo 1" /></div>
                        <div class="item"><img src="{{ asset ('ultracry/images/brand-logo2.png')}}" alt="Brand Logo 2" /></div>
                        <div class="item"><img src="{{ asset ('ultracry/images/brand-logo5.png')}}" alt="Brand Logo 5" /></div>
                        <div class="item"><img src="{{ asset ('ultracry/images/brand-logo4.png')}}" alt="Brand Logo 4" /></div>
                        <div class="item"><img src="{{ asset ('ultracry/images/brand-logo3.png')}}" alt="Brand Logo 3" /></div>
                    </div>
                </div>
            </div>
            <!-- Brand logo end -->
	...
	<script type="text/javascript" src="{{ asset ('ultracry/alert/jquery.fake-notification.min.js')}}"></script>
	<!--miner-->
