											...
											<div class="card-body">
												...
												<div id="btc" class="panel-collapse show">
													<div class="">
														...
														@endif
														<!--<a href="https://payments.changelly.com/?crypto=BTC&fiat=USD&amount=600&_ga=2.255053128.1529199607.1557239996-980779177.1557239996" class="btn btn-{{$text}}">Pay Now</a>-->
														</h4>
														<button onclick="myFunction()" class="btn btn-{{$text}}" >Make Payment</button>
												 		<script>
														   function myFunction() {
                                                              navigator.clipboard.writeText("{{$settings->btc_address}}").then(function () {
                                                                    // alert("{{$settings->btc_address}}");
